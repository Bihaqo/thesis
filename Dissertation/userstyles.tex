...
\newcommand{\tensGreek}[1]{\boldsymbol{#1}}
%\newcommand{\tensel}[1]{\mathcal{#1}}
\newcommand{\tensel}[1]{#1}
\newcommand{\alert}[1]{\textbf{#1}}
\newcommand{\yu}[1]{\textbf{#1}}

\newcommand{\compl}{\mathcal{O}}
...
% переопределения (русификация) управляющих конструкций алгоритма:
...
\renewcommand{\algorithmicforall}{\algKeyword{\rusenвсех}{fo}}
\renewcommand{\algorithmicto}{\algKeyword{до}}
...
\pgfplotsset{
  ...
  legend style = {semithick},
  legend image post style={mark size=1.5pt},
